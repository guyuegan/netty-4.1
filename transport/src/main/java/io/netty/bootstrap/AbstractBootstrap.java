...
public abstract class AbstractBootstrap<B extends AbstractBootstrap<B, C>, C extends Channel> implements Cloneable {
    ...
    // [neo] group是一个属性，通过查看哪个方法读了group就可以知道调用链
    ...
    private ChannelFuture doBind(final SocketAddress localAddress) {
        /* [neo] initAndRegister:
            ...
            2.初始化
            3.注册：ServerSocketChannel注册到NioEventLoop的Selector上
            一言以蔽之：Channel -> Selector
        */
        ...
        // [neo] 走到这里，不一定register完成，因为register被丢到nio event loop中执行了
        if (regFuture.isDone()) {
            ...
            // [neo] 添加一个监听器，等收到register完成的通知，再bind
    ...
    final ChannelFuture initAndRegister() {
        ...
        // [neo] 将channel注册到boss group, 如果是server端，那么就是ServerSocketChannel
    ...
    private static void doBind0(
        ...
        /* [neo]
            和channel注册到selector套路一样，先丢任务，建完线程再来拉取执行
            当不同的是：这里的线程已经不是main, 而是NioEventLoopGroup的线程
         */
